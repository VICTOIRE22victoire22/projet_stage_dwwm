    ...
    <section class="form-container">
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="pabx_brand" name="pabx_brand" value="<?= htmlspecialchars($pabx_brand) ?>" required>
            </div>

            <div class="form-group">
                <label for="pabx_model" class="form-label">Modèle du pabx :</label>
                <input type="text" class="form-input" id="pabx_model" name="pabx_model" value="<?= htmlspecialchars($pabx_model) ?>" required>
            </div>

            <div class="form-group">
                <label for="pabx_series_number" class="form-label">Numéro de série du pabx :</label>
                <input type="text" class="form-input" id="pabx_series_number" name="pabx_series_number" value="<?= htmlspecialchars($pabx_series_number) ?>" required>
            </div>

            <div class="form-group">
                <label for="pabx_building_id" class="form-label">Bâtiment du pabx :</label>
                <select name="pabx_building_id" id="pabx_building_id" class="form-input" required>
                    <option value="" disabled hidden>Sélectionner un bâtiment</option>
                    <option value="">En stock</option>
                    <?php foreach ($buildings as $building): ?>
                        <option value="<?= htmlspecialchars($building['building_id']) ?>" <?= $building['building_id'] === $pabx_building_id ? 'selected' : '' ?>>
