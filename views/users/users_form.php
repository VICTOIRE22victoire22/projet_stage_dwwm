    ...
    <!-- <h1 class="form-title">Ajout d'un nouvel utilisateur</h1> -->
    ...
    <section class="form-container">
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="user_firstname" name="user_firstname" required>
            </div>

            <div class="form-group">
                <label for="user_lastname" class="form-label">Nom :</label>
                <input type="text" class="form-input" id="user_lastname" name="user_lastname" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="user_login" name="user_login" required>
            </div>

            <div class="form-group">
                <label for="user_password" class="form-label">Mot de passe :</label>
                <input type="password" class="form-input" id="user_password" name="user_password" required>
            </div>
