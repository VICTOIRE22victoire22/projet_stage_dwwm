    ...
    <h1 class="form-title">
        Modifier une ligne téléphonique
    ...
    <section class="form-container">
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="phone_line_number" name="phone_line_number" value="<?= htmlspecialchars($phone_line_number) ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="phone_line_status" id="phone_line_status" class="form-input" required>
                    <?php foreach ($statues as $status): ?>
                        <option value="<?= htmlspecialchars($status) ?>" <?= $phone_line_status === $status ? 'selected' : '' ?>>
                            <?= ucfirst($status) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" id="phone_line_termination_number" name="phone_line_termination_number" value="<?= $phone_line_termination_number ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-input" id="phone_line_box_return_date" name="phone_line_box_return_date" value="<?= $phone_line_box_return_date ?>">
            </div>

            <div class="form-group">
                <label for="phone_line_designation" class="form-label">Désignation :</label>
                <input type="text" class="form-input" id="phone_line_designation" name="phone_line_designation" value="<?= $phone_line_designation ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="phone_line_agent_id" id="phone_line_agent_id" class="form-input">
                    ...
                    <?php foreach ($agents as $agent): ?>
                        <option value="<?= htmlspecialchars($agent['agent_id']) ?>" <?= $agent['agent_id'] === $phone_line_agent_id ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select name="phone_line_building_id" id="phone_line_building_id" class="form-input">
                    ...
                    <?php foreach ($buildings as $building): ?>
                        <option value="<?= htmlspecialchars($building['building_id']) ?>" <?= $building['building_id'] === $phone_line_building_id ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select name="phone_line_offer_id" id="phone_line_offer_id" class="form-input">
                    ...
                    <?php foreach ($offers as $offer): ?>
                        <option value="<?= htmlspecialchars($offer['offer_id']) ?>" <?= $offer['offer_id'] === $phone_line_offer_id ? 'selected' : '' ?>>
