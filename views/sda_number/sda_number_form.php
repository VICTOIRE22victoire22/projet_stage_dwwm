...
<head>
    <meta charset="UTF-8">
    <title>Ajout d'un nouveau numéro SDA</title>
    <link rel="stylesheet" href="../../css/form.css"/>
</head>
<body>

    <h1 class="form-title">Ajout d'un nouveau numéro SDA</h1>
    ...
    <section class="form-container">
        <form method="POST" action="">
            ...
            <div class="form-group" >
                ...
                <input type="text"  class="form-input" id="sda_number" name="sda_number" required>
            </div>
            ...
            <div class='form-group'>
                ...
                <?php foreach ($phone_lines as $phone_line): ?>
                    <option value="<?= htmlspecialchars($phone_line['phone_line_id']) ?>"
                        <?= $phone_line['phone_line_id'] == $selected_phone_line_id ? 'selected' : '' ?>>
